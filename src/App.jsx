...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#1e232e] flex items-center justify-center">
      ...
      <div className="relative z-10 w-[380px] sm:w-[500px] min-h-[520px] bg-[#252c3a] rounded-3xl shadow-2xl border-1 border-white/25 shadow-[0_8px_10px_rgba(0,0,0,0.6)] pomodoro-card">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Mode Selector */}
          <div className="flex gap-3 mb-2 w-full overflow-hidden rounded-xl px-6 mode-row">
          ...
          {/* Timer */}
          <div className="relative flex items-center justify-center w-full timer-wrapper" style={{ height: "170px" }}>
            ...
            <div className="absolute text-6xl font-bold text-white tracking-wider timer-text">
              {formatTime(timeLeft)}
            </div>
          </div>
          ...
          <div className="border-b-2 border-[#49525c] border-t-2 border-[#49525c] 
                          shadow-[0_4px_6px_rgba(0,0,0,0.6)] pt-1 w-full mb-4 px-6 bottom-counters">
